 ...
 */
public class GameNightInvestigatorFragment extends BaseGameFragment
{
	@InjectView(R.id.NIGHT_investigator_ready_button)
	Button m_readyButton;

	public static GameNightInvestigatorFragment newInstance()
	{
		GameNightInvestigatorFragment fragment = new GameNightInvestigatorFragment();
	...
	{
		final View view = inflater.inflate( R.layout.fragment_game_night_investigator, container, false );
	...
	@OnClick(R.id.NIGHT_investigator_ready_button)
