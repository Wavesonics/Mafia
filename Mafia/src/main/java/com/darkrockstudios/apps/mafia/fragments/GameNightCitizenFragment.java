 ...
 */
public class GameNightCitizenFragment extends BaseGameFragment
{
	@InjectView(R.id.NIGHT_citizen_ready_button)
	Button m_readyButton;

	public static GameNightCitizenFragment newInstance()
	{
		GameNightCitizenFragment fragment = new GameNightCitizenFragment();
	...
	{
		final View view = inflater.inflate( R.layout.fragment_game_night_citizen, container, false );
	...
	@OnClick(R.id.NIGHT_citizen_ready_button)
